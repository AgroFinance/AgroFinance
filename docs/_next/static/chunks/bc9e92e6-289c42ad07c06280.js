"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{35002:function(e,t,n){n.d(t,{ET:function(){return sv},IO:function(){return se},PL:function(){return sy},Xo:function(){return si},ad:function(){return iV},b9:function(){return sa},hJ:function(){return iR},qs:function(){return sT}});var r,i,s,a,o=n(48885),l=n(42680),u=n(19053),h=n(71028),c=n(76552),d=n(4575);n(20357);var f=n(9109).lW;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iO{constructor(e){this._byteString=e}static fromBase64String(e){try{return new iO(eu.fromBase64String(e))}catch(e){throw new A(C.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(e){return new iO(eu.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iU{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new A(C.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new A(C.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return O(this._lat,e._lat)||O(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sc(e,t,n){return e?n&&(n.merge||n.mergeFields)?e.toFirestore(t,n):e.toFirestore(t):t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class s_{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=ij(e)}set(e,t,n){this._verifyNotCommitted();let r=sE(e,this._firestore),i=sc(r.converter,t,n),s=iW(this._dataReader,"WriteBatch.set",r._key,i,null!==r.converter,n);return this._mutations.push(s.toMutation(r._key,tR.none())),this}update(e,t,n,...r){let i;this._verifyNotCommitted();let s=sE(e,this._firestore);return i="string"==typeof(t=(0,h.m9)(t))||t instanceof iF?function(e,t,n,r,i,s){let a=e.Qu(1,t,n),o=[i0(t,r,n)],l=[i];if(s.length%2!=0)throw new A(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i0(t,s[e])),l.push(s[e+1]);let u=[],c=eO.empty();for(let e=o.length-1;e>=0;--e)if(!i3(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Nu(t);if(n instanceof iH)u.push(t);else{let e=iY(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iz(c,new eo(u),a.fieldTransforms)}(this._dataReader,"WriteBatch.update",s._key,t,n,r):function(e,t,n,r){let i=e.Qu(1,t,n);iZ("Data must be an object, but it was:",i,r);let s=[],a=eO.empty();return ee(r,(e,r)=>{let o=i2(t,e,n);r=(0,h.m9)(r);let l=i.Nu(o);if(r instanceof iH)s.push(o);else{let e=iY(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iz(a,new eo(s),i.fieldTransforms)}(this._dataReader,"WriteBatch.update",s._key,t),this._mutations.push(i.toMutation(s._key,tR.exists(!0))),this}delete(e){this._verifyNotCommitted();let t=sE(e,this._firestore);return this._mutations=this._mutations.concat(new t$(t._key,tR.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new A(C.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function sE(e,t){if((e=(0,h.m9)(e)).firestore!==t)throw new A(C.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
