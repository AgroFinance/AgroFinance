...
import { CATALOGO_FACTORES } from '@/lib/ghgClassify'
import type { AlcanceBenchmark } from '@/lib/benchmarks'
import { useGastoAmbiental, resumirGasto, formatoPEN } from '@/lib/gastoAmbiental'
import { resumirODS, ESTADO_LABEL, NOTA_ODS } from '@/lib/ods'
