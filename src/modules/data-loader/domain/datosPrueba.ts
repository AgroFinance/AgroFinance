...
import { campos, packing, envios } from '@/modules/carbon-accounting/domain/pilotData'
import { aguaCampos, aguaPacking } from '@/modules/carbon-accounting/domain/pilotDataAgua'
import type { FuenteId, FuentesActivas } from '@/modules/carbon-accounting/domain/pilotEngine'
import { ghgClassify, type LineaClasificada, type LineaLeida, type ResumenClasificacion } from '@/modules/carbon-accounting/domain/ghgClassify'
import { FUENTES_TODAS_ACTIVAS } from '@/modules/carbon-accounting/domain/pilotEngine'
