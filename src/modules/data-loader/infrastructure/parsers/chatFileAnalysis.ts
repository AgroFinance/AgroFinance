...
import { parsearArchivo, validarArchivo, huellaArchivo, ErrorArchivo, type ResultadoParseo } from '@/modules/data-loader/infrastructure/parsers/parseArchivo'
import { ghgClassify, resumirLineas } from '@/modules/carbon-accounting/domain/ghgClassify'
import type { Mecanismo } from '@/modules/carbon-accounting/domain/emissionFactors'
