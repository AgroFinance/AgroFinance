...
import { FE, FUENTE_META, huellaFertilizante, type FuenteEmision } from '@/modules/carbon-accounting/domain/emissionFactors'
import { cooperativa } from '@/modules/carbon-accounting/domain/pilotEngine'
