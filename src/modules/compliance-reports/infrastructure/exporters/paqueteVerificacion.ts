...
import { MECANISMO_META } from '@/modules/carbon-accounting/domain/emissionFactors'
import { NIVEL_VALIDEZ } from '@/modules/compliance-reports/infrastructure/exporters/reporteTecnico'
import { CATEGORIA_META, MONEDA_SIMBOLO, aSoles, type EstadoGasto } from '@/modules/water-and-esg/domain/gastoAmbiental'
import type { ResumenODS } from '@/modules/water-and-esg/domain/ods'
import { ESTADO_LABEL, NOTA_ODS } from '@/modules/water-and-esg/domain/ods'
