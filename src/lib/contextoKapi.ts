...
import type { ResumenODS } from './ods'
import type { ResumenEsquema } from './inocuidad'
import type { HuellaHidrica } from './huellaHidrica'
import type { AccionReduccion } from './reduccionActions'
import type { Certificacion } from './certification'
import { MECANISMO_META, type Mecanismo } from './emissionFactors'
import { referenciaDe, deviationVsBenchmark, ALCANCES, type AlcanceBenchmark } from './benchmarks'
import { reduccionTon } from './reduccionActions'
import { CATEGORIA_META } from './gastoAmbiental'
import { ESTADO_LABEL } from './ods'
