...
import { CATALOGO_FACTORES } from './ghgClassify'
import { MECANISMO_META } from './emissionFactors'
import { NIVEL_VALIDEZ } from './reporteTecnico'
import { CATEGORIA_META, MONEDA_SIMBOLO, aSoles, type EstadoGasto } from './gastoAmbiental'
import type { ResumenODS } from './ods'
import { ESTADO_LABEL, NOTA_ODS } from './ods'
