...
// Vista de página completa de Kapi (/copilot/) — layout únicamente. Misma
// lógica que el widget flotante, vía useKapiChat (ver ese archivo para el
// porqué de la unificación).
import { motion, AnimatePresence } from 'framer-motion'
import {
  Send, TrendingDown, AlertTriangle, Leaf, Globe2, FileText, BarChart3,
  ArrowRight, Mic, ImagePlus, ClipboardList, Check, Loader2, Square, X,
...
export default function CopilotFullView() {
  const {
    hasData, huella, fuentesVivas, messages, isTyping, input, setInput, mode, registros,
