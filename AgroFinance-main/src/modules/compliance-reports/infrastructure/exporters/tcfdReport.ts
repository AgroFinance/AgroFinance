...
import type { ReporteTecnico } from '@/modules/compliance-reports/infrastructure/exporters/reporteTecnico'
import {
  ascii, num, titulo, subtitulo, parrafo, nota, estiloTabla, finTabla, pieDePagina,
  VERDE_OSCURO, GRIS, MARGEN, ANCHO, UTIL, type Cursor,
} from '@/modules/compliance-reports/infrastructure/exporters/pdfTecnico'
