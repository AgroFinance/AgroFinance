...
import { campos, packing, envios } from '@/lib/engine/pilotData'
import { aguaCampos, aguaPacking } from '@/lib/engine/pilotDataAgua'
import type { FuenteId, FuentesActivas } from '@/lib/engine/pilotEngine'
import { ghgClassify, type LineaClasificada, type LineaLeida, type ResumenClasificacion } from '@/lib/engine/ghgClassify'
import { FUENTES_TODAS_ACTIVAS } from '@/lib/engine/pilotEngine'
