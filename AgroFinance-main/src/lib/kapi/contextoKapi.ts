...
import type { Producto } from '@/lib/store/analyticsData'
import type { ResumenGasto } from '@/lib/engine/gastoAmbiental'
import type { ResumenODS } from '@/lib/engine/ods'
import type { ResumenEsquema } from '@/lib/engine/inocuidad'
import type { HuellaHidrica } from '@/lib/engine/huellaHidrica'
import type { AccionReduccion } from '@/lib/engine/reduccionActions'
import type { Certificacion } from '@/lib/engine/certification'
import { MECANISMO_META, type Mecanismo } from '@/lib/engine/emissionFactors'
import { referenciaDe, deviationVsBenchmark, ALCANCES, type AlcanceBenchmark } from '@/lib/engine/benchmarks'
import { reduccionTon } from '@/lib/engine/reduccionActions'
import { CATEGORIA_META } from '@/lib/engine/gastoAmbiental'
import { ESTADO_LABEL } from '@/lib/engine/ods'
