...
} from '@/lib/engine/emissionFactors'
import { CATALOGO_FACTORES, METODO_N2O } from '@/lib/engine/ghgClassify'
import {
...
import type { Anotaciones } from '@/lib/store/anotaciones'
import { claveVarianza } from '@/lib/store/anotaciones'
import { CATEGORIA_META, type ResumenGasto } from '@/lib/engine/gastoAmbiental'
import { ESTADO_LABEL, NOTA_ODS, type ResumenODS } from '@/lib/engine/ods'
