...
import type { AlcanceBenchmark } from '@/lib/engine/benchmarks'
import { useGastoAmbiental, resumirGasto, formatoPEN } from '@/lib/engine/gastoAmbiental'
import { resumirODS, ESTADO_LABEL, NOTA_ODS } from '@/lib/engine/ods'
import { useHuellaHidrica } from '@/lib/engine/huellaHidrica'
import { construirAcciones } from '@/lib/engine/reduccionActions'
import { generarPaqueteVerificacion } from '@/lib/reports/paqueteVerificacion'
