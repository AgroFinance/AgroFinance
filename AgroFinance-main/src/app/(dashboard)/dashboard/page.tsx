...
import ImpactToggle from '@/shared/components/ui/ImpactToggle'
import TerminoTooltip from '@/shared/components/ui/TerminoTooltip'
import { getLatestAnalysisFromFirestore, saveAnalysisToFirestore } from '@/modules/carbon-accounting/infrastructure/repositories/analysisRepository'
import { exportarPDF, type ExportData } from '@/modules/compliance-reports/infrastructure/exporters/exports'
import { useAuth } from '@/core/providers/AuthContext'
import { certificarCooperativa, cooperativa, serieMensual, coberturaDe } from '@/modules/carbon-accounting/domain/pilotEngine'
import { useHuellaConsolidada } from '@/modules/carbon-accounting/domain/huellaConsolidada'
import { reiniciarFuentesDemo } from '@/modules/data-loader/domain/datosPrueba'
import { construirTopFuentes, productos, empresa } from '@/modules/carbon-accounting/domain/analyticsData'
import { referenciaDe } from '@/modules/carbon-accounting/domain/benchmarks'
