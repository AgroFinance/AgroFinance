...
import { cooperativa, certificarCooperativa } from '@/modules/carbon-accounting/domain/pilotEngine'
...
import { coberturaDe } from '@/modules/carbon-accounting/domain/pilotEngine'
                  ...
                  <div className={`max-w-[75%] ${msg.role === 'ai' ? 'ai-bubble' : 'user-bubble'} px-4 py-3 text-xs leading-relaxed`}>
                    ...
                    {msg.showAutoload && (
                      <div className="mt-3 pt-2 border-t border-[rgba(90,190,145,0.15)]">
                        ...
                        <button
                          onClick={async () => {
                            const { certificarCooperativa, cooperativa: coop } = await import('@/modules/carbon-accounting/domain/pilotEngine')
                            ...
                            const { certificarCooperativa: cert } = await import('@/modules/carbon-accounting/domain/pilotEngine')
                            const cl = cert()
