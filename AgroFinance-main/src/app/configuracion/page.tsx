...
import {
  ...
  type FuenteDatos,
} from '@/lib/store/datosPrueba'
import { CATALOGO_FACTORES, ghgClassify, resumirLineas } from '@/lib/engine/ghgClassify'
import {
  parsearArchivo, validarArchivo, huellaArchivo, ACCEPT_ARCHIVOS, MAX_ARCHIVOS_LOTE, TAMANO_MAX_MB,
} from '@/lib/parsing/parseArchivo'
import { consolidar } from '@/lib/engine/huellaConsolidada'
