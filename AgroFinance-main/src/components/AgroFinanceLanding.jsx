...
import { cooperativa } from '@/lib/engine/pilotEngine';
import { empresa, scopes, topFuentes, fmtInt } from '@/lib/store/analyticsData';
import { construirAcciones, reduccionTon, reduccionPct, METALL } from '@/lib/engine/reduccionActions';
import {
  Leaf,
  LineChart,
  ArrowRight,
